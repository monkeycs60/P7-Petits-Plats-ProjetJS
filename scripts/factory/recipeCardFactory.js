export function recipeCardFactory(recipe) {
  ...
  function createRecipeCard() {
    ...
    <img class="w-[85vw] h-[19vh] rounded-lg rounded-b-none object-cover md:h-[14vh] 2xl:h-[17vh] 2xl:w-[26vw]" src="/P7-Petits-Plats-ProjetJS/assets/restaurantpreview.png" alt="restaurant card" />
    </div>
